...
<h1>ДОМАШНЕЕ ЗАДАНИЕ РАСПОЛОЖЕНО В КОНЦЕ КАЖДОГО УРОКА. НИЖЕ ПРЕДСТАВЛЕНО СОДЕРЖАНИЕ ДАННОГО ФАЙЛА. ЕСЛИ ВЫ ПЕРЕМЕСТИТЕСЬ В КОНЕЦ УРОКА "ВВОД-ВЫВОД ДАННЫХ", ТО УВИДИТЕ КЛИКАБЕЛЬНЫЙ ТЕКСТ "ДОМАШНЕЕ ЗАДАНИЕ 1". ЭТО И ЕСТЬ ТО ДОМАШНЕЕ ЗАДАНИЕ, КОТОРОЕ К ПЕРВОМУ УРОКУ.</h1>
<h1>ДОМАШНИЕ ЗАДАНИЯ НАХОДЯТСЯ В КОНЦЕ КАЖДОГО УРОКА (НИЖЕ ВЫ УВИДИТЕ СОДЕРЖАНИЕ)</h1>
<h1>Домашние задания находятся В КОНЦЕ каждого УРОКА</h1>
<h1>Домашние задания находятся в конце КАЖДОГО УРОКА</h1>
<h1>НИЖЕ ЕСТЬ СОДЕРЖАНИЕ, ГДЕ МОЖНО НАЖАТЬ НА НАЗВАНИЕ УРОКА ИИИИИИИИИИ</h1>
<h1>в конце КАЖДОГО урока есть домашние задания</h1>
